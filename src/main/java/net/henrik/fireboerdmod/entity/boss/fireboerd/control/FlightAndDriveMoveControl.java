package net.henrik.fireboerdmod.entity.boss.fireboerd.control;
...
public class FlightAndDriveMoveControl extends MoveControl {
    ...
    public FlightAndDriveMoveControl(MobEntity entity, int maxPitchChange, boolean noGravity, boolean isOnFlightMode) {
        ...
        this.isOnFlightMode = isOnFlightMode;
    }

    public void flightMoveControlTick() {
        // identical to net.minecraft.entity.ai.control.FlightMoveControl::tick
    ...
    @Override
    public void tick() {
        if (this.isOnFlightMode) {
            this.entity.setNoGravity(this.noGravity);
            this.flightMoveControlTick();
        } else {
            this.entity.setNoGravity(false);
            super.tick();
        }
    ...
    public void setOnFlightMode(boolean isOnFlightMode) {
        this.isOnFlightMode = isOnFlightMode;
    }
}
